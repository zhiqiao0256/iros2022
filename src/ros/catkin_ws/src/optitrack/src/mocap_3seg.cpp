...
void Callback4(const geometry_msgs::PoseStampedConstPtr& ps0, const geometry_msgs::PoseStampedConstPtr& ps1, const geometry_msgs::PoseStampedConstPtr& ps2,const geometry_msgs::PoseStampedConstPtr& ps3)
{
...
// Serialize (convert the data into a string) over zmq message AS PER THE ATT_POS_MOCAP_MSG PACK
    snprintf((char *) message.data(),140, "%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f",
                ...
                ps3->pose.position.x,ps3->pose.position.y,ps3->pose.position.z,
                ps3->pose.orientation.w,ps3->pose.orientation.x,ps3->pose.orientation.y,ps3->pose.orientation.z);
...
// Subscribe to the message of type "PoseStamped" published over the topic mentioned below in a buffer of size 1000
    ...
    typedef message_filters::sync_policies::ApproximateTime<geometry_msgs::PoseStamped, geometry_msgs::PoseStamped, geometry_msgs::PoseStamped, geometry_msgs::PoseStamped> MySyncPolicy;
    message_filters::Synchronizer<MySyncPolicy> sync(MySyncPolicy(10), base_sub, top_sub,top2_sub,top3_sub);
