...
L0_2 = 0.3727-L0_1;%0.3572+0.0153-L0_1;
L0 = L0_1+L0_2;
...
%         plotRobot();
        ...
        pressure_of_tubes(i+1,4) = 1+MPa_to_Psi*Pressure_from_actuator(i,1)*4; %positive y
        pressure_of_tubes(i+1,3) = 1+MPa_to_Psi*Pressure_from_actuator(i,2)*4; %negative y
