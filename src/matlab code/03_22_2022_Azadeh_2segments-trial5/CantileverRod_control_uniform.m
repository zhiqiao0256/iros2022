...
%Azadeh version created 03/23/22
...
pressure_of_tubes = [1,0,1,0;zeros(STEPS-1,N*2)];
...
bias_base = [0.1197;-0.2170;-0.0151];
R_base_initial = [ 1.0000    0.0000    0.0001
                  -0.0000    1.0000   -0.0000
                  -0.0001    0.0000    1.0000];

bias_segment_1 = [0.1266;-0.2172;-0.0151]; %0.1612

R_seg1_initial  = [0.9994    0.0011    0.0356
                  -0.0010    1.0000   -0.0005
                  -0.0356    0.0005    0.9994];

bias_segment_2 = [0.1360;-0.2210;-0.0151]; %0.3569

R_seg2_initial  = [0.9994   -0.0039    0.0347
                   0.0042    1.0000   -0.0067
                  -0.0347    0.0068    0.9994];
%%
for i = 1:STEPS
    i
    tic;
...
%         plotRobot();
        ...
        pressure_of_tubes(i+1,4) = 0;%1+MPa_to_Psi*Pressure_from_actuator(i,1)*2; %positive y
        pressure_of_tubes(i+1,3) = 1+MPa_to_Psi*Pressure_from_actuator(i,2)*3; %negative y
        pressure_of_tubes(i+1,2) = 0;%1+MPa_to_Psi*Pressure_from_actuator(i,3)*3; %positive x
        pressure_of_tubes(i+1,1) = 1+MPa_to_Psi*Pressure_from_actuator(i,4)*3; %negative x
