...
%Azadeh version created 04/21/22
...
pressure_of_tubes = [0,0,0,1;zeros(STEPS-1,N*2)];
...
recv = tcpserver("10.203.50.247",6666)
...
%             h2*h4 - h3*h1 , h3*h4 + h2*h1 , -h2^2 - h3^2];
       ...
       position_local_segment_2 = (R_seg2_initial'*R_seg2)'*position_global_segment_2';
        ...
        if abs(position_local_segment_1(2))<=0.00000001
            ...
            kapa(2) = -(1.2)*2*position_local_segment_1(2)/(position_local_segment_1(2)^2+position_local_segment_1(3)^2);              
        ...
        if abs(position_local_segment_2(1))<=0.00000001
            ...
            %curvature_about_y_axis 
            kapa(3) = -(1.2)*2*position_local_segment_2(1)/(position_local_segment_2(1)^2+position_local_segment_2(3)^2);              
