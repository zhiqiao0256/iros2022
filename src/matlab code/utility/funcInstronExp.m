function par_set = funcInstronExp( par_set,exp_case )
fprintf( 'Loading exp. data %d ... \n',exp_case )
switch exp_case
    case 1
        set1=importdata('data_1.txt');
    case 2
        set1=importdata('data_2.txt');
    case 3
        set1=importdata('data_3.txt');
    case 4
        set1=importdata('data_4.txt');
    case 5
        set1=importdata('data_5.txt');
    case 6
...
par=[];
time_set=(set1(1:end,1)-set1(1,1))/1000;% in second
...
par.pm_Pa = NoLoad(1:end,1) ; par.pm_Pa(:,2) = 1e5 *( NoLoad(1:end,2))* 0.0689476;
par.pm_psi = NoLoad(1:end,1) ; par.pm_psi(:,2) = ( NoLoad(1:end,2));
par.pm_MPa=NoLoad(1:end,1) ; par.pm_MPa(:,2) = 1e-1 *( NoLoad(1:end,2))* 0.0689476;
par.force=NoLoad(:,3);
% c7-c18
