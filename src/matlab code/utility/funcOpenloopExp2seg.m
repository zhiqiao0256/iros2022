function par_set = funcOpenloopExp2seg( par_set,exp_case )
...
par.base_exp = NoLoad(1:end,1) ; par.base_exp(:,2:4) = ( NoLoad(1:end,5:7)  - mean(NoLoad(1:end,5:7)) ) ;
par.base_RQ = NoLoad(1:end,1) ; par.base_RQ(:,2:5) = ( NoLoad(1:end,8:11) ) ;
