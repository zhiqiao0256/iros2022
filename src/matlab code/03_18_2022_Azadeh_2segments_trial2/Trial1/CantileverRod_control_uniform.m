...
x_bias_segment_1 = 7.7800e-04-x_bias_base;
y_bias_segment_1 = 0.0015-y_bias_base;
z_bias_segment_1 = z_bias_base;
R_seg1_initial  = [1.0000   -0.0001   -0.0006
                   0.0001    1.0000    0.0011
                   0.0006   -0.0011    1.0000];

x_bias_segment_2 = 0.0071-x_bias_base;
y_bias_segment_2 = 0.0020-y_bias_base;
z_bias_segment_2 = z_bias_base;
...
%        position_global_base = mocap_data(1:3)-[x_bias_base,y_bias_base,z_bias_base];
       position_global_segment_1 = mocap_data(8:10)-[x_bias_segment_1,y_bias_segment_1,z_bias_segment_1];
       position_global_segment_2 = mocap_data(15:17)-[x_bias_segment_2,y_bias_segment_2,z_bias_segment_2];
