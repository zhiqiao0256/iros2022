...
%Azadeh version created 03/13/22
%Bending for grasping-Silicone
%Bias in pressure and all other variables (ud,vd,x,z,u_star,v_star,n0,m0)
...
y_bias = 4.2200e-04;
z_bias = 0.1844;
R_initial = [ 1.0000   -0.0006   -0.0020
              0.0006    1.0000    0.0010
