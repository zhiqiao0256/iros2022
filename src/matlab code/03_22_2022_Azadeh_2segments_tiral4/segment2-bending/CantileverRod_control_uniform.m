...
%         plotRobot();
        ...
        pressure_of_tubes(i+1,2) = 0;%1+MPa_to_Psi*Pressure_from_actuator(i,3); %positive x
        pressure_of_tubes(i+1,1) = 0;%1+MPa_to_Psi*Pressure_from_actuator(i,4); %negative x
