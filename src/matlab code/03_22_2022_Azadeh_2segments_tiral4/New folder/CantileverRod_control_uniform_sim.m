...
%         plotRobot();
        ...
        pressure_of_tubes(i+1,4) = 1+MPa_to_Psi*Pressure_from_actuator(i,1); %positive y
        pressure_of_tubes(i+1,3) = 1+MPa_to_Psi*Pressure_from_actuator(i,2); %negative y
        pressure_of_tubes(i+1,1) = 1+MPa_to_Psi*Pressure_from_actuator(i,3); %negative x
        pressure_of_tubes(i+1,2) = 1+MPa_to_Psi*Pressure_from_actuator(i,4); %positive x
