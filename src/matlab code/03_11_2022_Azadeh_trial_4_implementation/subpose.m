...
% recv= tcpserver("10.203.49.203",5555)
% datasize=14;
% for i =1:1000
%     i
...
%     if size(mocap_data,1)>0
       ...
       y_bias_initial= position_global(2)
       z_bias_initial= position_global(3)
       position_global(1) = position_global(1)-x_bias_initial;
       position_global(2) = position_global(2)-y_bias_initial;
       position_global(3) = position_global(3)-z_bias_initial;
       ...
       Tip_angles = quat2eul(mocap_data(11:14),'zyx');
       phi_tip=Tip_angles(1)
       theta_tip=Tip_angles(2)
       psi_tip=Tip_angles(3)
