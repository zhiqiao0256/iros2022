...
Kb = diag([E*J(1,1), E*J(2,2), G*J(3,3)]); % Stiffness matrix for bending(d1,d2) and extension(d3) [N.m^2]
...
g = [0 ; 0 ; -9.81] ;  %gravity accelaration [m/s^2]
...
a = 1;  %amplitude of bending limited by the design and worksapce
freq = 1; %frequency of bending limited by air pressure speed [Hz]
w = 2*pi*freq;  
